            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-0 p-1">
                        <a href="/admin/buku/tambah" class="btn btn-primary"> <i class="fas fa-plus-square mr-1"></i>
                            Tambah</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($list_buku as $buku)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="/admin/buku/{{ $buku->id }}/ubah"
                                                    class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="showHapus({{ $buku->id }})"><i class="fa fa-trash"
    ...
    <div class="modal fade" id="modelTelahKembali" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="/admin/buku/status">
                    @csrf
                    @method('PUT')
    ...
    <div class="modal fade" id="modelHapus" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="/admin/buku/hapus">
                    @csrf
                    @method('DELETE')
